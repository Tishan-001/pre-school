  ...
  void sendMessage() async {
    ...
    if (msg != "") {
      ...
      MessageModel newMessage = MessageModel(
        messageid: messageId,
        sender: widget.userModel.id, // Assuming 'id' is the correct field
        ...
        title: Row(
          children: [
            CircleAvatar(
              ...
              backgroundImage: NetworkImage(widget.targetUser.profilePictureUrl!),
            ),
            SizedBox(width: 10),
